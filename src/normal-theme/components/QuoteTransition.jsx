...
const QuoteTransition = () => {
    ...
    // Parallax & Opacity effects - Optimized for all devices
    ...
    // Background parallax - Reduced movement on mobile
    const bgY = useTransform(scrollYProgress, [0, 1], ["0%", "15%"]);

    // Text parallax - Conditional based on screen size
    ...
    return (
        <section
            ref={containerRef}
            className="relative 
                       min-h-[50vh] sm:min-h-[55vh] md:min-h-[60vh] lg:min-h-[65vh] 
        ...
        >
            ...
            <div className="absolute inset-0 pointer-events-none">
                {/* Cinematic Noise - Reduced on mobile */}
                <div
                ...
                {/* Subtle Grid - Hidden on mobile, visible on tablet+ */}
                <div
                ...
                {/* Vertical Glowing Lines (Cyber Brackets) - Hidden on mobile */}
                <motion.div
                ...
                {/* Moving Light Source - Responsive sizing */}
                <motion.div
                    style={{ y: bgY }}
                ...
                <div className="hidden sm:block">
                    {["01", "10", "11", "00"].map((bit, i) => (
                        <motion.div
                            ...
                            className="absolute text-cyan-900/20 font-mono 
            ...
            >
                {/* Decorative Top Icon - Responsive height */}
                <motion.div
                ...
                >
                    ...
                    >
                        ...
                        {/* Subtle text shadow duplication for depth - Hidden on mobile */}
                    ...
                    >
                        ...
                        <motion.span
                            ...
                            className="absolute 
                                       ...
                                       rounded-full"
                        />
                        <span className="relative z-10 text-transparent bg-clip-text bg-gradient-to-r from-cyan-300 via-white to-cyan-400 
                                         drop-shadow-[0_0_10px_rgba(34,211,238,0.25)] 
                                         sm:drop-shadow-[0_0_12px_rgba(34,211,238,0.3)] 
                                         md:drop-shadow-[0_0_15px_rgba(34,211,238,0.35)]">
                            optimize by day.
                        </span>
                    </motion.span>
                </h2>

                {/* Enhanced Decorative Divider - Responsive sizing */}
                <div className="mt-8 sm:mt-10 md:mt-12 
                    ...
                    <motion.div
                        ...
                        className="w-1.5 h-1.5 sm:w-2 sm:h-2 
                                   ...
                                   sm:shadow-[0_0_10px_rgba(34,211,238,0.5)]"
                    />
                    <motion.div
                        initial={{ width: 0 }}
                        whileInView={{ width: 32 }}
