...
import {
    FaTimes, FaMinus, FaRegWindowMaximize, FaFirefoxBrowser, FaPlus,
    FaEllipsisV, FaBookmark, FaDownload, FaHistory, FaCog, FaLock,
    FaStar, FaRegStar, FaHome
} from 'react-icons/fa';
import {
    BiSolidLeftArrow,
    BiSolidRightArrow,
...
export default function FireFoxBrowser({
    ...
    return (
        <div className="flex flex-col bg-black/70 backdrop-blur-md overflow-hidden relative w-full h-full">
            <div
            ...
            >
                {/* Title Bar - DRAGGABLE */}
                <div className="window-drag-handle bg-gradient-to-r from-cyan-950/20 to-[#1a1a1aE6]
                    px-2 xs:px-3 sm:px-4
                    py-2 xs:py-2.5 sm:py-3
                    border-b border-cyan-500/20 flex items-center justify-between select-none
                    cursor-default">

                    <div className="flex items-center gap-1.5 xs:gap-2 no-drag">
                        <button
                ...
                >
                    ...
                    {isLoading && activeTab?.content !== "iframe" ? (
                        <div className="flex items-center justify-center h-full relative z-10 text-cyan-300 font-sans select-none">
                            <div className="flex flex-col items-center space-y-3 xs:space-y-4">
                                ...
                                <div className="relative w-16 h-16 xs:w-20 xs:h-20">
                                    ...
                                    <div className="absolute inset-0 flex items-center justify-center">
                                        <FaFirefoxBrowser className="text-2xl xs:text-3xl text-cyan-300" aria-hidden="true" />
                                    </div>
                                </div>

                                {/* text */}
                                <div className="text-center space-y-1.5">
                                    <p className="text-xs xs:text-sm text-cyan-100/80">Loading page...</p>
                                    <p className="text-[10px] xs:text-xs font-mono text-cyan-400/60 truncate max-w-[280px] xs:max-w-sm px-2">
                                        {activeTab?.url}
                                    </p>
                                </div>
                            </div>
